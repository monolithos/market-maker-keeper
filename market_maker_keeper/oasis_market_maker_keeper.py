...
class OasisMarketMakerKeeper:
    ...
    def __init__(self, args: list, **kwargs):
        ...
        support_address = Address(self.arguments.oasis_support_address) if self.arguments.oasis_support_address else None

        self.otc = MatchingMarket(web3=self.web3,
                                  address=Address(self.arguments.oasis_address),
                                  support_address=support_address)

        tub = Tub(web3=self.web3,
                  address=Address(self.arguments.tub_address)) if self.arguments.tub_address is not None else None
