...
class ParadexMarketMakerKeeper:
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument("--paradex-api-server", type=str, default='https://api.paradex.io/api/v1/',
                            help="Address of the Paradex API (default: 'https://api.paradex.io/api/v1/')")
        ...
        parser.add_argument("--keeper-name", type=str, required=False,
                            help="market maker keeper name (e.g. 'Uniswap_V2_MDTETH')", default="paradex")
